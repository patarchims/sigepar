...
@section('content')
@section('title','SIGEPAR  | Tambah Data Jemaat')
      ...
      <div class="container-fluid">
        ...
        <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title"> Form Tambah Data  Jemaat HKI Parsoburan</h3>
            </div>
            <div class="card-body">
              <!-- Minimal style -->
              <div class="row">
                <div class="col-sm-6">
                    ...
                    <form action="/Data_jemaat/create" method="POST" enctype="multipart/form-data">
                        {{@csrf_field()}}
                    <div class="form-group" {{$errors->has('nama_lengkap')? 'hash-error':''}}>
                        <label for="exampleInputEmail1">Nama Lengkap</label>
                        <input type="text" name="nama_lengkap" class="form-control" id="exampleInputEmail1" placeholder="Nama Lengkap" value="{{old('nama_lengkap')}}">
                      ...
                      <div class="form-group" {{$errors->has('keluarga')? 'hash-error':''}}>
                        ...
                        <input type="text"  name="keluarga" class="form-control" id="keluarga" placeholder="Nama Keluarga">
                      ...
                      <div class="form-group" {{$errors->has('no_hp')? 'hash-error':''}}>
                        ...
                        <div class="input-group mb-3">   
                            ...
                            <input type="text" name="no_hp" class="form-control" placeholder="Masukkan Kontak Jemaat" value="{{old('no_hp')}}">
                            @if($errors->has('no_hp'))
                      ...
                      <div class="form-group" {{$errors->has('tanggal_lahir')? 'hash-error':''}}>
                        ...
                        <input type="date"  name="tanggal_lahir" class="form-control" id="tanggal_lahir" placeholder="Tanggal Lahir" value="{{old('tanggal_lahir')}}">
                      ...
                      <div class="form-group" {{$errors->has('tanggal_bergabung')? 'hash-error':''}}>
                        ...
                        <input type="date"  name="tanggal_bergabung" class="form-control" id="tanggal_bergabung" placeholder="Tanggal Bergabung" value="{{old('tanggal_bergabung')}}">
