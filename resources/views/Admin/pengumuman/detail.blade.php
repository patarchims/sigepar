              ...
              <div class="row">
                <div class="col-sm-12">
                    ...
                    <form action="/pengumumanCreate" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group" {{$errors->has('$data->tanggal')? 'hash-error':''}}>
                        ...
                        @if($errors->has('$data->tanggal'))
                        <span class="help-block">{{$errors->first('$data->tanggal')}}</span>
                        @endif
                      </div>


                    <div class="form-group" {{$errors->has('$data->judul_pengumuman')? 'hash-error':''}}>
                        ...
                        @if($errors->has('$data->judul_pengumuman'))
                        <span class="help-block">{{$errors->first('$data->judul_pengumuman')}}</span>
                        @endif
                      </div>
