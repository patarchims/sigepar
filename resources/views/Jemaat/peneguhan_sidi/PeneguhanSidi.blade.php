    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
                ...
                <div class="col-sm-6">
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group" >
                       <input type="text" name="nama_ayah" class="form-control" value="" id="exampleInputEmail1">                        
                      </div>
                      <hr>
                      <strong><i class="fas fa-mars-and-venus mr-1"></i> Nama Ibu</strong>
                        <div class="form-group" >
                       <input type="text" name="nama_ibu" class="form-control" value="" id="exampleInputEmail1">                        
                      </div>
                      <hr>
                      ...
                      <div class="form-group" >
                        <input type="date"  name="tgl_resmi_jemaat" class="form-control"  placeholder="Tanggal Resmi Jemaat HKI" value="">                       
                      </div>
                      <hr>                     
                    </div>
                    <!-- /.card-body -->
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <strong><i class="fas fa-book mr-1"></i> Nama Lengkap</strong>
                      <div class="form-group" >
                       <input type="text" name="nama_sidi" class="form-control" value="" id="exampleInputEmail1">                        
                      </div>
                    <hr>
                    ...
                    <strong><i class="fas fa-calendar-days mr-1"></i> Tanggal lahir</strong>
                      <div class="form-group" >
                        <input type="date"  name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="">                       
                      </div>
                    <hr>
                    <strong><i class="fas fa-calendar-days mr-1"></i> Tanggal Dibaptis</strong>
                      <div class="form-group" >
                        <input type="date"  name="tgl_babtis_sidi" class="form-control"  placeholder="Tanggal Babtis" value="">                       
                      </div>
                    <hr>
            ...
            <div class="col-12">
            <button type="submit" class="btn btn-primary btn-block">Daftar Peneguhan Sidi</button>
          </div>
        </form>
                    <!-- /.card-body -->
